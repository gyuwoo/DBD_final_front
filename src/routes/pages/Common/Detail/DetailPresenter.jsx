        ...
        <div>
            <Layout>
                <div className="detail-container">
                    {/* 프로그램 제목 */}
                    <div className="d-program-header">
                        <h2 className="d-program-title">{programData.program_name}</h2>
                    ...
                    {/* 프로그램 상세 내용 */}
                    <div className="d-program-content">
                        {/* 이미지 */}
                        <div className="d-program-image">
                            <img
                                src={getProgramImage(programData.id)}
                                alt={programData.program_name}
                                className="d-program-poster"
                            />
                        </div>
